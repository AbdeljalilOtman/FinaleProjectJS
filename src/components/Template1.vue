<template>
  ...
  <div class=" p-1  rounded-lg shadow-lg" id="template">
  <div class="flex">
    <!-- Left Column -->
    <div class="w-2/5 p-4  bg-orange-900 text-white rounded-lg">
      <div class="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p class="text-xl text-black-300">
            <textarea v-model="templateData.jobTitle" placeholder="Enter your job title" class="w-full bg-transparent border-none focus:outline-none text-black-300 auto-resize"></textarea>
          </p>
        </div>
      </div>
      <div class="mt-4 mb-6">
        <h2 class="text-2xl font-semibold border-b pb-2 border-black-400 text-black-400">Contact Info</h2>
      ...
      <div class="mt-8">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-400">Skills</h2>
        <div class="mt-4">
      ...
      <div class="mt-8">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-400">Languages</h2>
        <div class="mt-4">
          <draggable class="dragArea list-group w-100" :list="templateData.list" @change="log">
      ...
      <div class="mt-8">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-400">Others</h2>
        <div class="mt-4">
          <draggable class="dragArea list-group w-100" :list="templateData.list" @change="log">
    ...
    <div class="w-3/5 p-4 bg-white rounded-lg">
      <div class="mt-8 mb-6">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-900">Profile</h2>
        <textarea v-model="templateData.profile" placeholder="Enter your profile" class="w-full mt-4 bg-transparent border-none focus:outline-none text-black-900 auto-resize"></textarea>
      </div>
      <div class="mt-8 mb-6">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-900">Experience</h2>
        <draggable class="dragArea list-group w-100" :list="templateData.list" @change="log">
          <div v-for="(experience, index) in templateData.experiences" :key="index" class="mt-4 border-b pb-4 border-black-300">
            <h3 class="text-xl font-semibold text-black-900">
              <textarea v-model="experience.jobTitle" placeholder="Enter job title" class="w-full bg-transparent border-none focus:outline-none text-black-900 auto-resize"></textarea>
            </h3>
            <p class="text-sm text-black-600">
              <textarea v-model="experience.company" placeholder="Enter company" class="w-full bg-transparent border-none focus:outline-none text-black-600 auto-resize"></textarea>
              -
              <textarea v-model="experience.period" placeholder="Enter period" class="w-full bg-transparent border-none focus:outline-none text-black-600 auto-resize"></textarea>
            </p>
            <textarea v-model="experience.description" placeholder="Enter job description" class="w-full mt-2 bg-transparent border-none focus:outline-none text-black-900 auto-resize"></textarea>
        ...
        <font-awesome-icon icon="circle-plus" @click="addExperience" size="xl" class="mt-4 text-black-900 hover:underline icon flex justify-center cursor-pointer transition-transform duration-300 hover:animate-spin"/>
      </div>
      <div class="mt-8">
        <h2 class="text-2xl font-semibold border-b pb-2 text-black-900">Education</h2>
        <draggable class="dragArea list-group w-100" :list="templateData.list" @change="log">
          <div v-for="(education, index) in templateData.education" :key="index" class="mt-4 border-b pb-4 border-black-300">
            <h3 class="text-xl font-semibold text-black-900">
              <textarea v-model="education.degree" placeholder="Enter degree" class="w-full bg-transparent border-none focus:outline-none text-black-900 auto-resize"></textarea>
            </h3>
            <p class="text-sm text-black-600">
              <textarea v-model="education.institution" placeholder="Enter institution" class="w-full bg-transparent border-none focus:outline-none text-black-600 auto-resize"></textarea>
              -
              <textarea v-model="education.period" placeholder="Enter period" class="w-full bg-transparent border-none focus:outline-none text-black-600 auto-resize"></textarea>
            </p>
            <textarea v-model="education.description" placeholder="Enter description" class="w-full mt-2 bg-transparent border-none focus:outline-none text-black-900 auto-resize"></textarea>
        ...
        <font-awesome-icon icon="circle-plus" @click="addEducation" size="xl" class="mt-4 text-black-900 hover:underline icon flex justify-center cursor-pointer transition-transform duration-300 hover:animate-spin"/>
      </div>
    </div>
  </div>
</div>
