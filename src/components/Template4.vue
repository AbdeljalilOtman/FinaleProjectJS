<template>
  <div class="max-w-full overflow-x-auto my-2 p-2 bg-gray-100 rounded-lg shadow-lg min-w-screen-lg relative" id="template">
    <div class="flex flex-col md:flex-row">
      <!-- Left Column -->
      <div class="w-full md:w-1/3 p-4 bg-gray-800 text-white rounded-lg">
      ...
      <!-- Right Column -->
      <div class="w-full md:w-2/3 p-4 bg-gray-200 rounded-lg">
        <div class="mt-8 mb-6">
